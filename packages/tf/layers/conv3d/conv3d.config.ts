...
{name: "strides", isRequired: false, defaultValue: Tuple.of(Int.of(1), Int.of(1), Int.of(1)) },
{name: "padding", isRequired: false, defaultValue: Str.of("valid") },
{name: "data_format", isRequired: false, defaultValue: None.of() },
{name: "dilation_rate", isRequired: false, defaultValue: Tuple.of(Int.of(1), Int.of(1), Int.of(1)) },
{name: "groups", isRequired: false, defaultValue: Int.of(1) },
