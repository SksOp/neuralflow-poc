...
{name: "dilation_rate", isRequired: false, defaultValue: Tuple.of(Int.of(1), Int.of(1)) },
...
{name: "pointwise_initializer", isRequired: false, defaultValue: Str.of("glorot_uniform") },
...
{name: "pointwise_regularizer", isRequired: false, defaultValue: None.of() },
...
{name: "pointwise_constraint", isRequired: false, defaultValue: None.of() },
